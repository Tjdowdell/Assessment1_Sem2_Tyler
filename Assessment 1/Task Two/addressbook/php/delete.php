...
$contactfname = $_GET['contactfname'];
...
if ($result) {
	...
	$_SESSION['success'] = "You have deleted " . $firstname . " " . $lastname . " in your address book!";
...
<link href="../css/mystyle.css" rel="stylesheet" type="text/css">
  ...
  <div class="wrapper">
   <div class="row">
    ...
    <header>
    	<h1>Delete a Mate from Your Address Book</h1>
    </header>
	</div>
<div class="row">
	<div class="col-sm-1">
                ...
                <div class="row">
				  ...
				  <form role="form" action= "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                    <div class="input-group">
					  ...
					  <input type="hidden" class="form-control" value="<?php echo $row['Contact_ID']; ?>" aria-describedby="basic-addon1" name="contactid" >
                    </div>
                  </div>
                  <br><br>
                  <div class="col-lg-7 col-md-7 col-sm-11 col-xs-11">
